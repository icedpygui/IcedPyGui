...
class IPG:
    ...
    def add_table(self,
                    ...
                    *,
                    ...
                    button_fill_columns: Optional[list[int]]=None,
                    checkbox_fill_columns: Optional[list[int]]=None,
        ...
        ----------
            ...
            button_fill_columns: Optional[list[int]]=None
                List of column indexes to fill with a button.
            checkbox_fill_columns: Optional[list[int]]=None
    ...
    def add_text_input_style(self,
        ...
        Add textInput styling.
            ...
            ----------
                ...
                border_radius: Optional[list[float]]=None
                    The roundness of the border cormers, [1 value]=all, [4 values]=[top-left, top-right, bottom-right, bottom-left]
                # icon_color: Optional[IpgColor]=None
