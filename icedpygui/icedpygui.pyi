...
class IPG:
    ...
    def add_divider_horizontal(
        ...
        """
        Adds a divider widget that allow one to change the sizes of adjacent containers in the horizontal direction

        Args:
            parent_id (str):
                Id of another container to place the widget in.
            widths (list[float]): 
                Unique index of the divider
            handle_width (float):
                Width of handle
            handle_height (float):
                Height of handle
            handle_offsets (list[float], optional)
                Offsets are calculated by subtracting 1/2 of the handle width or height from each width and subtraction the whole width or height from the last item in the list if used.  Supply others if this doesn't align the handle over the joint between containers. 
            on_change (Callable, optional): Defaults to None.
                Callback function when the value changes.
            on_release (Callable, optional): Defaults to None.
                Callback function for when the mouse is released
            width (float, optional): Defaults to None.
                Width of underlying range.
            width_fill (_type_, optional): Defaults to true.
                The width of the underlying range will fill the parent container width.
            height (float, optional): Defaults to None.
                Width of underlying range.
            height_fill (_type_, optional): Defaults to true.
                The height of the underlying range will fill the parent container height.
            direction (IpgDirection, optional): Defaults to IpgDividerDirection::Horizontal.
                The direction of the underlying range area.
            style_id (_type_, optional): Defaults to None.
                The id of the style add_divider_style() function.
            gen_id (int, optional): Defaults to None.
                The only allowable entry for this id is that generated by ipg.generate_id().
            user_data (any, optional): Defaults to None.
                Any data that might be needed in the callback function.
            show (_type_, optional): Defaults to true.
                To show the widget or not.
    ...
    def add_divider_vertical(
        ...
        """
        Adds a divider widget that allow one to change the sizes of adjacent containers in the vertical direction.
...
class IpgDividerParam:
    ...
    Widths: list[float],
        The widths for divider_horizontal
    Heights: List[float],
        The heights for divider_vertical
    StyleId: int,
        The id of the add_divider_style()
    Show: bool,
        Wheterh to show the widget or not.
    """
    HandleWidth:float
    HandleHeight:float
    Widths:list[float]
