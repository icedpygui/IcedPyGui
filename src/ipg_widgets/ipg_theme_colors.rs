...
//     use super::{hex_to_color, IpgColorType};
...
//     impl Serialize for IpgColorType {
...
//     impl<'de> Deserialize<'de> for IpgColorType {
//         fn deserialize<D>(deserializer: D) -> Result<IpgColorType, D::Error>
//         where
//             D: Deserializer<'de>,
//         {
