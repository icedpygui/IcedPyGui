...
use crate::chart::geometries::{IpgArc, IpgBezier, IpgCircle, IpgEllipse, IpgFreeHand, 
    IpgLine, IpgPolyLine, IpgPolygon, IpgRightTriangle, IpgText, IpgChartWidget};
use crate::{chart::draw_chart::IpgDrawMode, 
chart::chart_helpers::{build_polygon, get_angle_of_vectors, 
