...
use iced::keyboard;
use iced::advanced::{layout, Layout, Shell, Widget};
use iced::mouse;
use iced::overlay;
...
use iced::{
    Background, Color, Element, Length, Pixels, Point,
    ...
    Renderer: iced::advanced::Renderer,
{
    ...
    on_scroll: Option<Box<dyn Fn(usize, Viewport) -> Message + 'a>>,
    style: Theme::Style,
}
    ...
    Renderer: iced::advanced::Renderer,
{
    ...
    /// Sets the ipg_id of the [`Scrollable`].
    pub fn ipg_id(mut self, ipg_id: usize) -> Self {
        self.ipg_id = ipg_id;
        self
    }
    ...
    pub fn on_scroll(mut self, f: impl Fn(usize, Viewport) -> Message + 'a) -> Self {
...
pub fn update<Message>(
    ...
    direction: Direction,
    ipg_id: usize,
    on_scroll: &Option<Box<dyn Fn(usize, Viewport) -> Message + '_>>,
    ...
    match event {
        Event::Mouse(mouse::Event::WheelScrolled { delta }) => {
            ...
            notify_on_scroll(state, ipg_id, on_scroll, bounds, content_bounds, shell);
...
fn notify_on_scroll<Message>(
    ...
    if let Some(on_scroll) = on_scroll {
        ...
        shell.publish(on_scroll(ipg_id, viewport));
