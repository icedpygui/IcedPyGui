...
use iced::{
    Background, Border, advanced::Clipboard, Color, Element, advanced::Layout, Length, Pixels,
    Rectangle, advanced::Shell, Size, Theme, advanced::Widget,
};
    ...
    Theme: Catalog,
{
    ...
    /// Sets the function that will be called when the  is toggled.
