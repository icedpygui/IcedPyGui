...
ipg.add_text(
        parent_id="controls", 
        content="Until height > size of bar items, the height will not increase.")

ipg.add_row(
        window_id="main-light", 
        container_id="slider-2", 
        parent_id="controls")
...
ipg.add_text(
        parent_id="controls", 
        content="Reset the height to zero then see padding effect. \n Otherwise, the surrounding padding will quash to bar items when big enough")

ipg.add_row(
        window_id="main-light", 
        container_id="slider-3", 
        parent_id="controls")
