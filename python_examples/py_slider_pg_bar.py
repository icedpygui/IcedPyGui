...
ipg.add_text(
        parent_id="col", 
        content="Use the Slider to Change the Values")
...
on_change_id = ipg.add_text(
                    parent_id="col", 
                    content=f"On Change value is 0")

on_release_id = ipg.add_text(
                    parent_id="col", 
                    content=f"On Release value is 0")
